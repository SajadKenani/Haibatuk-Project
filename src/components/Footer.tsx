      ...
      <div className="container mx-auto px-6 md:px-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-20">
          ...
          <div className="flex flex-col items-center md:items-start">
            ...
            <ul className="space-y-3 text-lg">
              <li>
                <i className="fas fa-phone-alt text-teal-600 mr-2"></i>
              ...
              <li>
                <i className="fas fa-clock text-teal-600 mr-2"></i>
        ...
        <div className="mt-10 mb-20 text-center" style={{zIndex: 99999}}>
          <p className={`text-md ${theme === "light" ? "text-gray-700" : "text-gray-200"}`}>
            {"Designed & Developed By "}
            <a
              href="https://sajadkenani.site"
              target="_blank"
